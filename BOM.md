# Gripper – Bill of Materials (BOM)

This BOM lists all components required to build the gripper. Quantities are for **one gripper**.
...
> **Note:** Equivalent parts from other suppliers may be used as long as specifications match.